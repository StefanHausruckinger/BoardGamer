...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.MessageAdapterViewHolder> {

    private Context context;
    private List<Message> messages;
    private DatabaseReference messageDb;

    public EventsAdapter(Context context, List<Message> messages, DatabaseReference messageDb)
    {
